 ...
 * Chakra UI E2E Tests
 * 
 * Tests superconnect pipeline against Chakra UI React design system.
 * 
 * VALIDATION LAYERS:
 ...
 * 
 * RUN MODES:
 * - Full: RUN_CHAKRA_E2E=1 pnpm test:e2e:chakra
 * - Subset: RUN_CHAKRA_E2E=1 CHAKRA_E2E_ONLY=Button,Alert pnpm test:e2e:chakra
 * - Keep artifacts: CHAKRA_E2E_KEEP=1 (preserves temp dir for inspection)
...
const FIGMA_URL = 'https://www.figma.com/design/7jkNETbphjIb9ap1M7H1o4/Chakra-UI----Figma-Kit--v3---Community-?m=auto&t=0XdgVxllEy8vO4w1-6';
const DESIGN_SYSTEM = 'chakra';
 ...
 * @param {string[]} connectors - List of generated .figma.tsx files
...
maybeTest('generates valid Code Connect with correct semantic mappings', () => {
  ...
  const subset = getOnlyList('CHAKRA_E2E_ONLY');
  if (subset?.length) {
    console.log(`Chakra E2E (subset): ${subset.join(', ')}`);
  }
